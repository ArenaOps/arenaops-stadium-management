    ...
    <aside className="h-full">
      ...
      <div className="mt-4 rounded-md border border-slate-200 bg-slate-50 p-3 text-xs text-slate-700 shadow-sm">
        ...
        <div className="mt-2 flex gap-2">
          <button
            ...
            className={`flex-1 rounded-md border px-2 py-1 text-[11px] font-semibold transition ${selectionMode === "single"
          ...
          <button
            ...
            className={`flex-1 rounded-md border px-2 py-1 text-[11px] font-semibold transition ${selectionMode === "multi"
                ? "border-emerald-500 bg-emerald-50 text-emerald-700"
                : "border-slate-200 text-slate-600 hover:border-emerald-400"
              }`}
          >
      ...
      <div className="mt-4 space-y-2">
        ...
        <div className="grid gap-2">
          {(["rows", "rows+seats", "seats"] as const).map((mode) => (
            <button
              ...
              className={`rounded-md border px-3 py-2 text-xs font-semibold transition ${seatDensityMode === mode
                  ? "border-emerald-500 bg-emerald-50 text-emerald-700"
                  : "border-slate-200 text-slate-600 hover:border-emerald-400"
                }`}
            >
        ...
        <button
          ...
          className={`rounded-md border px-3 py-2 text-xs font-semibold transition ${showSeatNumbers
              ? "border-emerald-500 bg-emerald-50 text-emerald-700"
              : "border-slate-200 text-slate-600 hover:border-emerald-400"
            }`}
        >
