        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2 lg:items-center">
          <div className="flex flex-col gap-8">
            ...
            <h1 className="text-5xl font-bold leading-[1.1] tracking-tight text-white md:text-7xl">
              The Future of{" "}
              <span className="text-primary italic">Arena Management</span> is
              Here.
            </h1>
            <p className="max-w-xl text-lg leading-relaxed text-slate-400 md:text-xl">
              Experience the industry&apos;s first dashboard-driven event
              management platform. Precision planning meets real-time execution
              in a single glass-pane view.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link
                href="/register-event-manager"
                className="rounded-lg bg-primary px-8 py-4 text-lg font-bold text-background-dark hover:shadow-[0_0_20px_rgba(71,244,37,0.4)] transition-all"
              >
                Start Free Trial
              </Link>
          ...
          <div className="relative group">
            <div className="absolute -inset-1 rounded-2xl bg-linear-to-r from-[primary]/50 to-transparent opacity-20 blur group-hover:opacity-40 transition duration-1000"></div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 flex flex-col items-center text-center">
            ...
            <p className="mt-6 max-w-2xl text-slate-400">
              Everything you need to orchestrate world-class events, from seat
              selection to revenue optimization.
            </p>
          </div>
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="flex flex-col gap-6 rounded-2xl p-8 bg-surface-dark/70 backdrop-blur-md border border-primary/10 hover:bg-primary/5 hover:border-primary/30 transition-all duration-300 group">
              ...
              <div>
                ...
                <p className="text-slate-400 leading-relaxed">
                  Drag-and-drop seating charts with glassmorphism UI. Preview
                  sightlines and accessibility in real-time 3D.
                </p>
              </div>
              <div className="relative w-full h-40 mt-auto">
                <Image
                  alt="Layout Tool"
                  className="rounded-lg object-cover grayscale opacity-50 group-hover:grayscale-0 transition-all"
                  fill
                  data-alt="Digital seating chart plan for a stadium"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuAsfYksZ-09If9y1JQz1_voRFy5XxscAE8PV1ULs_N013tnL6V5auxvE58TXAAFFaBQ9Tp-Uhld1vlG2xBN0QmGYGdevIrfQ4uCVApIKt2wDUhfaNOXxtAOc534HHeYleQgKNAz7y5e_QGSIe15wYSvWneowYUR8NPvXAI7xt_PiwzehSiGFLW52bJEk8KXf1iTyQvmHYCvPastkBx8HqfQ48Bpih0gHMFl2Iz2eFS5-y6kgA4Kp9riTuZYSvHq8UfCrVIf6sOaOg1Q"
                />
              </div>
            </div>
            {/* Card 2 */}
            <div className="flex flex-col gap-6 rounded-2xl p-8 border-t-2 border-t-[primary]/50 bg-surface-dark/70 backdrop-blur-md border-x border-b border-primary/10 hover:bg-primary/5 hover:border-primary/30 transition-all duration-300 group">
              ...
              <div>
                ...
                <p className="text-slate-400 leading-relaxed">
                  AI-driven algorithms to maximize revenue per seat.
                  Automatically adjust prices based on demand velocity and
                  inventory.
                </p>
              </div>
              <div className="relative w-full h-40 mt-auto">
            ...
            <div className="flex flex-col gap-6 rounded-2xl p-8 bg-surface-dark/70 backdrop-blur-md border border-primary/10 hover:bg-primary/5 hover:border-primary/30 transition-all duration-300 group">
              ...
              <div>
                ...
                <p className="text-slate-400 leading-relaxed">
                  Live heatmaps and entry flow analytics. Monitor gate
                  congestion and VIP arrival alerts instantly.
                </p>
              </div>
              <div className="relative w-full h-40 mt-auto">
                <Image
                  ...
                  className="rounded-lg object-cover grayscale opacity-50 group-hover:grayscale-0 transition-all"
                  fill
                  data-alt="Abstract heatmap visualization of crowd flow"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCt_xF94TvVlE7kd2kYElIS7vroE5TK8MFh_n-bhOOYvs0gL31emkzeYFVVmbl743pzuTuW0tz_mfBOkdJriyPqMnV6XQ3J5InjtPCwD1YOKNS4ukPccr6GhdSamx8AANeZZ-6M-egcxgR-MD-pA1bj0agn0psAIbY06abIv_VG1kaZkqHZ2jyjWf4mWm43O4B6eBp_H3nffUEf5T7X3WTBw_0WZoA2jbM9BUwDUNKqk1_w0GGz9BzHMvc14rKBmleLrK1QL_WhSqc4"
                />
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-20 text-left">
            ...
            <p className="mt-4 text-slate-400">
              Streamline your workflow from initial concept to grand opening.
            </p>
          </div>
          <div className="space-y-24">
            ...
            <div className="flex flex-col items-center gap-12 lg:flex-row">
              <div className="flex-1 space-y-6">
                ...
                <p className="text-lg text-slate-400 leading-relaxed">
                  Import your venue blueprints or use our template library.
                  Define zones, security perimeters, and concession hubs in
                  minutes.
                </p>
              </div>
              <div className="flex-1 rounded-2xl bg-surface-dark p-2 border border-primary/10">
                <div className="relative w-full h-48">
                  <Image
                    alt="Planning Step"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCnqJmYW7acJLJAnVD5AULoxTya3P2qb6MoH1w8ze0aUTcpPuZd9dxVRiiKXBpLbBDtFWxJ6fsyAlQKTJhuisnwCaYQszYo0ICOPcc6W0nwMwKh7-qQx8knNSCw0BAu4CpXGWicRkSHkJ22c5EEuyKfNbAjmkFvS4-Ca_7EVPhbPNDtwkKc5dyI-qPQP4LkXnXWTdyMSxbRcLx0ccFajTeLQSCLdyv749CWD40Cwpm8eXI9ZW27W-jgwJnufoi48bF0Fpl8EBy4ldA9"
                    fill
            ...
            <div className="flex flex-col items-center gap-12 lg:flex-row-reverse">
              <div className="flex-1 space-y-6">
                ...
                <p className="text-lg text-slate-400 leading-relaxed">
                  Set up tiered ticketing, dynamic pricing rules, and branded
                  landing pages. Integrate with your favorite CRM and marketing
                  tools.
                </p>
              </div>
              <div className="flex-1 rounded-2xl bg-surface-dark p-2 border border-primary/10">
                <div className="relative w-full h-48">
                  <Image
                    ...
                    className="rounded-xl object-cover"
                    fill
                    data-alt="Customization settings menu in the software"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuBrU5TbX7HY8awrzXN1jYDm2yfbwlDEmo7Lww3PZbX7rEbFF6JcIDMwqO9T814U8E5bYwMa-B3eqOduaTFQhfPOlYN6TXeWhV9G3uJ6j8Y6bkOQuGEpHHnWebQwB6vCbO0wivITbFyxu_eTqLkBpqBS9saBLK9qpwlRaBpYCDzB4WI6tv9SIgQAngG0quDEecxLde647FsEcUrcU0V3m7I1JtbIbz606Xzzb8AvfaC8CR54SYhV4XTSkyOMlrrw8lA9ngrs3BqkTCN3"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-12 lg:flex-row">
              <div className="flex-1 space-y-6">
                ...
                <p className="text-lg text-slate-400 leading-relaxed">
                  Go live and watch the data flow. Your dashboard becomes the
                  command center for the entire event lifecycle.
                </p>
              </div>
              <div className="flex-1 rounded-2xl bg-surface-dark p-2 border border-primary/10">
                <div className="relative w-full h-48">
                  <Image
                    ...
                    className="rounded-xl object-cover"
                    fill
                    data-alt="Crowd at a live stadium event"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuC7bREV7ZJZU3PHiXMYlEikxA2miImBTeCR3WGZYBDUFDtXmYhTkvMQR2EzWFvUC19Bnf3VLel45ZgLb1G7K6MuqESwt7yXLZOZgnERZtyt7GkgSCiC0pX3ZHpyxqpcrlM54heFIs_18vajc6s01cNa2ytfeThRTA1c3fSywqpC6vsZkIDevqyFPAU09IBk-rxHO4bOBGkpgco81s92H-ev-QLmBg0qsxdMriqwsxCnNCP85WblWm07KhPmd8W5odW_ibZOOEPuDUyb"
                  />
                </div>
              </div>
            </div>
      ...
      <section className="bg-primary/5 px-6 py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <blockquote className="text-2xl font-medium italic text-white md:text-4xl leading-snug">
            &quot;ArenaManager didn&apos;t just change how we sell tickets; it
            changed how we understand our fans. The real-time heatmaps are a
            game-changer for stadium logistics.&quot;
          </blockquote>
          <div className="mt-10 flex flex-col items-center gap-4">
            <Image
              ...
              data-alt="Professional portrait of a stadium manager"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuD9btHGBZxNeiRIlTaCi7e0jj89DRUPfx0Z-3ZZMw8De0Co7PYtvzEzgN8Uiv8dk4-xfwUZPjso5EicnGGNexsqnEav8Scp3SbzYJlIQZPd6_hyU5F2Z84WV1rTZIhgmsIVtRzrsG3jWxId4_9Sjf8q1iy1N-G6w6vJoigV1UEos-vs6Pragsarsw8RQmSDKcd-f5jPStKS4ogJaCoswJwAvuosaQJqPUeI5citMJsyvk5CRakjOU0SypV-URwS2I0SRl8Pa-IyLuUN"
            />
            <div>
              <p className="font-bold text-white">Marcus Thorne</p>
              <p className="text-sm text-primary uppercase tracking-widest font-bold">
                Director of Operations, Global Sphere Arena
              </p>
            </div>
          </div>
        </div>
